import { createOctokitCommit } from '../../../ci/version-management/src/functions/octokit/create-octokit-commit';
import { createOctokitTag } from '../../../ci/version-management/src/functions/octokit/create-octokit-tag';
...
export const fixtures = {
  patch: {
    ...
    ].map(createOctokitCommit),
    latestTag: createOctokitTag({ name: '1.2.3' }),
    packageJson: {
      version: '1.2.3',
  ...
  increasePrereleaseVersion: {
    ...
    latestTag: createOctokitTag({ name: '1.2.3-beta.0' }),
    packageJson: {
  ...
  publishPatchPrerelease: {
    ...
    latestTag: createOctokitTag({ name: '1.2.4-beta.0' }),
    packageJson: {
  ...
  publishMinorPrerelease: {
    ...
    latestTag: createOctokitTag({ name: '1.3.0-beta.0' }),
    packageJson: {
  ...
  publishMajorPrerelease: {
    ...
    latestTag: createOctokitTag({ name: '2.0.0-beta.0' }),
    packageJson: {
